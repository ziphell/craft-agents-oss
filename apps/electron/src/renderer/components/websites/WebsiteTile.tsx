...
export function WebsiteTile({ website, project, onOpen, onDelete }: WebsiteTileProps) {
  ...
  React.useEffect(() => {
    ...
    void window.electronAPI
      .getWebsiteThumbnail(website.workspaceId, config.slug)
      .then((result) => {
  ...
  }, [website.workspaceId, config.slug, posterDigest, inView])

  const refreshPreview = React.useCallback(() => {
    void window.electronAPI
      .regenerateWebsiteThumbnail(website.workspaceId, config.slug)
      .then((queued) => {
  ...
  }, [website.workspaceId, config.slug, t])
