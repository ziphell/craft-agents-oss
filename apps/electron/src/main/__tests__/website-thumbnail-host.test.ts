...
describe('website-thumbnail-host', () => {
  it('applies the same sandbox rule as WebsiteFrame', () => {
  ...
  it('delivers the data snapshot via the craft-websites/v1 init message', () => {
    ...
    expect(html).toContain('craft-websites/v1')
  ...
  it('static websites still embed content (no scripts, snapshot irrelevant)', () => {
