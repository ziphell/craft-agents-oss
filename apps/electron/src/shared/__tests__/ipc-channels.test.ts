...
const EXPECTED_CHANNELS: string[] = [
  ...
  'views:list',
  'views:save',
  'websites:cancelAction',
  'websites:changed',
  'websites:create',
  'websites:createLease',
  'websites:delete',
  'websites:executeAction',
  'websites:get',
  'websites:getContent',
  'websites:getData',
  'websites:getOne',
  'websites:getShareCapabilities',
  'websites:getShareDataScan',
  'websites:getThumbnail',
  'websites:issueGrant',
  'websites:listGrants',
  'websites:publish',
  'websites:regenerateThumbnail',
  'websites:releaseLease',
  'websites:revokeGrant',
  'websites:setContent',
  'websites:setPublicationPassword',
  'websites:unpublish',
  'websites:update',
  'window:cancelClose',
  'window:close',
