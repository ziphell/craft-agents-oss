...
/**
 * Growth bounds on the per-website store. Points per series were always pruned
 ...
 * (rollback on violation): WebsiteDataStore for refresh scripts, and the
 * data-write one-shot for host/tool patches.
 */
export const WEBSITE_DATA_MAX_KV_KEYS = 1000;
export const WEBSITE_DATA_MAX_SERIES = 100;
